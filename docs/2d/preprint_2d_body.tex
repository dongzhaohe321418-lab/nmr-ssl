\section{\texorpdfstring{Learning to predict \(^{1}\)H and \(^{13}\)C NMR chemical shifts jointly from unassigned 2-D HSQC peak lists}{Learning to predict \^{}\{1\}H and \^{}\{13\}C NMR chemical shifts jointly from unassigned 2-D HSQC peak lists}}\label{learning-to-predict-1h-and-13c-nmr-chemical-shifts-jointly-from-unassigned-2-d-hsqc-peak-lists}

\emph{v2 preprint draft --- 2026-04-13. Builds on the 1-D sort-match method (Paper 1, \texttt{docs/preprint\_v1\_filled.md}).}
...
\subsubsection{The multi-nucleus training bottleneck}\label{the-multi-nucleus-training-bottleneck}
...
\subsubsection{Theorem 2 (Sliced sort-match)}\label{theorem-2-sliced-sort-match}
...
\subsubsection{Dataset and experiment}\label{dataset-and-experiment}
...
\subsubsection{\texorpdfstring{Results (3 seeds, mean \(\pm\) std)}{Results (3 seeds, mean \textbackslash pm std)}}\label{results-3-seeds-mean-pm-std}
...
\subsubsection{Conformal calibration and structure verification}\label{conformal-calibration-and-structure-verification}
...
\subsubsection{Chemistry demonstration}\label{chemistry-demonstration}
...
\subsubsection{Sliced sort-match loss}\label{sliced-sort-match-loss}
...
\subsubsection{Dual-head model architecture}\label{dual-head-model-architecture}
...
\subsubsection{Split-conformal calibration}\label{split-conformal-calibration}
...
\subsubsection{Structure-verification protocol}\label{structure-verification-protocol}
