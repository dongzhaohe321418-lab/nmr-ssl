...
\def\maketitle{%
  ...
  \begin{center}
    ...
    \vspace{1.2em}
    {\large\sffamily Eric Dong\textsuperscript{1,*}\par}
    \vspace{0.4em}
    {\footnotesize\textsuperscript{1}Independent researcher.\quad
     \textsuperscript{*}Correspondence: this work was developed with
     AI-assisted code and draft generation under human direction; the
     author bears final responsibility for all methodological choices,
     claims, and errors.\par}
    \vspace{0.6em}
